...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationProgress "Installing SonicWall NetExtender. This may take some time. Please wait..."
        Execute-MSI -Action Install -Path "$MsiPath64" -AddParameters "TRANSFORMS=$Transform64 /norestart /qn netlogon=true SERVER=gbassoc.com.au:4433 DOMAIN=gbassoc.com.au"
        }
        ...
        Show-InstallationProgress "Installing SonicWall NetExtender. This may take some time. Please wait..."
        Execute-MSI -Action Install -Path "$MsiPath64" -AddParameters "/norestart /qn netlogon=true SERVER=gbassoc.com.au:4433 DOMAIN=gbassoc.com.au"
        }  
